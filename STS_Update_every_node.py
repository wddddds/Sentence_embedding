...
def trainIters(detector, combiner, decoder, n_iters, n_per_iter, print_every=100, plot_every=100, learning_rate=0.05):
    start = time.time()
    plot_losses = []
    ...
    for i in range(n_iters):
        file = open('/home/dw1215/PycharmProjects/first_pytorch/data/encoded_upd_every_node{}'.format(i), 'w')
...
trainIters(detector1, combiner1, decoder1, 100, 100000, print_every=50)
