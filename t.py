...
def train(input_variable, embedding, detector, combiner, decoder, detector_optimizer, combiner_optimizer, decoder_optimizer, criterion, criterion2):
    ...
    for i in range(input_length-1):
        ...
        if current_sentence.size()[1] != 2:
            ...
            for i in range(input_length):
                loss += criterion(current_representation[:, i, :], input_variable_embedded[:, i, :])
                # print(current_representation[:, i, :])
    ...
    return loss.data[0] / input_length, path, encoded_sent, output_sentence
    ...
    for i in range(n_iters):
        ...
        for iter in range(len(all_sent)):
            ...
            loss, path, encoded_sentence, output_sentence = train(input_variable, embedding, detector, combiner,
                                                 decoder, detector_optimizer, combiner_optimizer, decoder_optimizer, criterion, criterion2)
...
trainIters(detector1, combiner1, decoder1, 10, print_every=10)
